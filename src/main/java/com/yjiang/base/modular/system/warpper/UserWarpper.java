 ...
 */
package com.yjiang.base.modular.system.warpper;
...
public class UserWarpper extends BaseControllerWrapper {
    ...
    protected void wrapTheMap(Map<String, Object> map) {
        Integer sex = 0;
        try {
            sex = Integer.parseInt(map.get("gender").toString());
        } catch (Exception e) {

        }
        map.put("sexName", ConstantFactory.me().getSexName(sex));
        map.put("roleName", ConstantFactory.me().getRoleName((String) map.get("role_ids")));
        map.put("deptName", ConstantFactory.me().getDeptName((Integer) map.get("deptid")));
        map.put("statusName", ConstantFactory.me().getStatusName((Integer) map.get("state")));
    }
