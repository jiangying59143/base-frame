...
import com.yjiang.base.core.log.LogManager;
...
public class GmapUtil {
    ...
    public static void main(String[] args) {
        //获取提示
        /*String returnStr = getKeywordsAddByLbs("淞泽", "苏州");
        JSONObject jsonObject = JSONObject.parseObject(returnStr);
        JSONArray jsonArray = JSONObject.parseArray(jsonObject.getString("pois"));
        ...
        //获取静态地图
        String mapStr = getMap("120.779829", "31.240744");
     ...
     * @return
     */
    public static String getTipsByKeywordAndCity(String keyWord, String city) {
        StringBuffer s = new StringBuffer();
        s.append("key=" + key + "&keywords=");
        if (keyWord.contains(" ")) {
            String[] str = keyWord.split(" ");
        ...
        s.append("&city=" + city);
        String around = sendPost("https://restapi.amap.com/v3/assistant/inputtips", s.toString());
        logger.info(around);
        return around;
    }

    public static List<Map> getMapByKeyWordAndCity(String keyWord, String city) {
        String returnStr = getKeywordsAddByLbs(keyWord, city);
    ...
    public static List<Map> getMapByKeyWordAndCityTips(String keyWord, String city) {
        String returnStr = getTipsByKeywordAndCity(keyWord, city);
        if(StringUtils.isBlank(returnStr)){
            return null;
        }
        JSONObject jsonObject = JSONObject.parseObject(returnStr);
    ...
    public static String getMap(String longtitude, String latitude){
        StringBuffer s = new StringBuffer();
        s.append("key=" + key + "&markers=mid,0xFF0000,A:");
        s.append(longtitude + "," + latitude);
        String map = sendPost("https://restapi.amap.com/v3/staticmap", s.toString());
        logger.info(map);
        return map;
    }
