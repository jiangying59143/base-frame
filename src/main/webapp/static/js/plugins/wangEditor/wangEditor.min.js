!function (e, t) {
    ...
    function j(e, t) {
        ...
        this.id = "MyWangEditor.wangEditor-" + W++, this.toolbarSelector = e, this.textSelector = t, this.customConfig = {}
    }
    ...
    L.prototype = {
        constructor: L, _alert: function (e, t) {
            ...
            if (i) throw new Error("MyWangEditor.wangEditor: " + (t || e));
            ...
            if (e) {
                ...
                r.onload = function () {
                    ...
                    r = null, t._alert("插入图片错误", 'MyWangEditor.wangEditor: 插入图片出错，图片链接是 "' + e + '"，下载该链接失败')
                }, r.onabort = function () {
                    r = null
                }, r.src = e
            }
...
//# sourceMappingURL=MyWangEditor.wangEditor.min.js.map
